...
# 新增配置
read -p "请输入您的 AZURE_URL (可选): " AZURE_URL
read -p "请输入您的 AZURE_API_KEY (可选): " AZURE_API_KEY
read -p "请输入您的 AZURE_API_VERSION (可选): " AZURE_API_VERSION
